...
Name=$(curl -sS https://raw.githubusercontent.com/bukhorimukammad/VPN/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/bukhorimukammad/VPN/main/izin | grep $MYIP | awk '{print $3}')
